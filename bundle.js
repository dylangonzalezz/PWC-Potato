...
(function ($) {
  ...
  var slideintodms = function slideintodms() {
    return new slideintodms.init();
  };

  var rotate = function rotate(leftright, array) {
    //Handle empty values
    array = array || [];
  ...
  slideintodms.prototype = {
    ...
    getAllSliders: function getAllSliders() {
    ...
    buttonhandler: function buttonhandler() {
      ...
      function createhandle(i) {
        ...
        $(".slideNjsbuttonright" + i).click(function () {
          ...
          divarray[i][x[0]].css(_defineProperty({
            width: "33%",
            display: "inline-block",
            opacity: "0.5",
            "text-overflow": "clip",
            "text-align": "center"
          }, "display", "inline-block")).html(divcontent[i][x[0]]);

          divarray[i][x[1]].css(_defineProperty({
            width: "33%",
            display: "inline-block",
            "text-overflow": "clip",
            "text-align": "center"
          }, "display", "inline-block")).html(divcontent[i][x[1]]);

          divarray[i][x[2]].css((_divarray$i$x$2$css = {
            width: "33%",
            display: "inline-block",
            opacity: "0.5",
            "text-overflow": "clip"
          }, _defineProperty(_divarray$i$x$2$css, "display", "inline-block"), _defineProperty(_divarray$i$x$2$css, "text-align", "center"), _divarray$i$x$2$css)).html(divcontent[i][x[2]]);
        });

        $(".slideNjsbuttonleft" + i).click(function () {
          var _divarray$i$x$0$css2, _divarray$i$x$1$css2, _divarray$i$x$2$css2;
          ...
          divarray[i][x[0]].css((_divarray$i$x$0$css2 = {
            width: "33%",
            display: "inline-block",
            opacity: "0.5",
            "text-overflow": "clip"
          }, _defineProperty(_divarray$i$x$0$css2, "display", "inline-block"), _defineProperty(_divarray$i$x$0$css2, "text-align", "center"), _divarray$i$x$0$css2)).html(divcontent[i][x[0]]);
          divarray[i][x[1]].css((_divarray$i$x$1$css2 = {
            width: "33%",
            display: "inline-block",
            "text-overflow": "clip"
          }, _defineProperty(_divarray$i$x$1$css2, "display", "inline-block"), _defineProperty(_divarray$i$x$1$css2, "text-align", "center"), _divarray$i$x$1$css2)).html(divcontent[i][x[1]]);
          divarray[i][x[2]].css((_divarray$i$x$2$css2 = {
            width: "33%",
            display: "inline-block",
            opacity: "0.5",
            "text-overflow": "clip"
          }, _defineProperty(_divarray$i$x$2$css2, "display", "inline-block"), _defineProperty(_divarray$i$x$2$css2, "text-align", "center"), _divarray$i$x$2$css2)).html(divcontent[i][x[2]]);
        });
      }
    },
    ...
    setstylerotation: function setstylerotation(nr, slidernr) {
      ...
      for (var i = 0; i < divarray.length; i++) {
        ...
        divarray[i][0].css(_defineProperty({
          width: "33%",
          display: "inline-block",
          opacity: "0.5",
          "text-overflow": "clip",
        ...
        divarray[i][1].css(_defineProperty({
          width: "33%",
          display: "inline-block",
          "text-overflow": "clip",
          "text-align": "center"
        ...
        divarray[i][2].css(_defineProperty({
          width: "33%",
          display: "inline-block",
          opacity: "0.5",
          "text-overflow": "clip",
